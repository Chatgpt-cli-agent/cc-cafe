...
- S4MM-style mods SQLite file index (fingerprints, package classification, resource TGIs) used by fingerprint / merge / TGI / HQ texture / region map tools when built
